...
class CheckForObjectsAction(genpy.Message):
  _md5sum = "75d77185361f8dd01232fa3817f7ac0b"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_h3I().pack(_x.action_result.result.id, _x.action_result.result.boundingBoxes.header.seq, _x.action_result.result.boundingBoxes.header.stamp.secs, _x.action_result.result.boundingBoxes.header.stamp.nsecs))
      _x = self.action_result.result.boundingBoxes.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.action_result.result.boundingBoxes.boundingBoxes)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_result.result.boundingBoxes.boundingBoxes:
        _x = val1.Class
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_result.result.id, _x.action_result.result.boundingBoxes.header.seq, _x.action_result.result.boundingBoxes.header.stamp.secs, _x.action_result.result.boundingBoxes.header.stamp.nsecs,) = _get_struct_h3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_result.result.boundingBoxes.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.action_result.result.boundingBoxes.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_result.result.boundingBoxes.boundingBoxes = []
      for i in range(0, length):
        ...
        self.action_result.result.boundingBoxes.boundingBoxes.append(val1)
      _x = self
      start = end
      end += 12
