...
class CheckForObjectsResult(genpy.Message):
  _md5sum = "b7095776bbf2dd52b93a4ce86a7902c0"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.boundingBoxes is None:
        self.boundingBoxes = darknet_ros_msgs.msg.BoundingBoxes()
    else:
      self.id = 0
      self.boundingBoxes = darknet_ros_msgs.msg.BoundingBoxes()
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_h3I().pack(_x.id, _x.boundingBoxes.header.seq, _x.boundingBoxes.header.stamp.secs, _x.boundingBoxes.header.stamp.nsecs))
      _x = self.boundingBoxes.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.boundingBoxes.boundingBoxes)
      buff.write(_struct_I.pack(length))
      for val1 in self.boundingBoxes.boundingBoxes:
        _x = val1.Class
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.id, _x.boundingBoxes.header.seq, _x.boundingBoxes.header.stamp.secs, _x.boundingBoxes.header.stamp.nsecs,) = _get_struct_h3I().unpack(str[start:end])
      start = end
      end += 4
      ...
      if python3:
        self.boundingBoxes.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.boundingBoxes.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        self.boundingBoxes.boundingBoxes.append(val1)
      return self
