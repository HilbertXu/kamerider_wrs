...
class NodeCreator:
    ...
    def taskCallback(self,msg):
        if msg.data == 'operation_start':
            ...
            os.system('gnome-terminal -x bash -c "rosrun interactive_cleanup GetGCPinDarknet -base_link_Name base_link -rgbdFrame_Name head_rgbd_sensor_depth_frame -ResEtheld 1 -ResSetHeadT 4 -DarknetShouldNum 3 -xmlPath /home/kamerider/sim_ws/src/CleanUp/interactive_cleanup/MPoseNew.xml && read"')
        ...
        if msg.data == 'grasp_start':
            ...
            print '-----------EL PSY CONGROO-------------'
            os.system('gnome-terminal -x bash -c "rosrun interactive_cleanup DOFmove_AutoGcp -isNav true -Kvx 1 -Kvy 1 -eTheld 0.005 -FocusRow 72 -FocusCol 320 -dT 0.1 -headT 5 true && read"')
            os.system("sleep 1")
