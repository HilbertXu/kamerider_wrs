...
string out_dir = "/home/kamerider/sim_ws/src/CleanUp/interactive_cleanup/output_file";
...
void ReadModelsXml(string &xml_dir, Mat &M_Pos_Furniture, vector<string> &Furniture_Names,
									Mat &DCP_In_Map, vector<string> &DCP_Names)
{
