...
class openpose_ros:
	...
	def openpose(self,msg):
		...
		if msg.data == 'start':
			...
			os.system("./build/examples/openpose/openpose.bin --image_dir /home/kamerider/sim_ws/src/CleanUp/interactive_cleanup/openpose_img --hand true --write_keypoint /home/kamerider/sim_ws/src/CleanUp/interactive_cleanup/json_files --write_keypoint_format xml --write_images /home/kamerider")
